...
function send_mail()
{
    sendEmail -f clearinfo@game-reign.com -t opteam@game-reign.com -u "[$1][$game][${servername}][online:${online_number}][clear result][$(date +'%Y-%m-%d %H:%M:%S')]" -m "$2"  -o message-charset=utf8
}
#参数：1、文件路径
function download()
{
