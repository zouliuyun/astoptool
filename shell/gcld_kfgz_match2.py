...
def getAliveOpenServers():
    ...
    for i in range(len(serverlist)):
        ...
        if ip == '169.53.149.124':
            infoMap={'gcld_vava8_1':[(47,1,8),(88,2,8),(51,3,8)],
                    'gcld_vava8_12':[(25,1,6),(49,2,8),(20,3,6)],
                    'gcld_vava8_21':[(8,1,7),(9,2,6),(2,3,4)],
                    'gcld_vava8_22':[(3,1,3),(6,2,6),(8,3,4)],
                    'gcld_vava8_23':[(2,1,3),(1,2,3),(4,3,5)],
                    'gcld_vava8_24':[(5,1,5),(2,2,4),(0,3,1)],
                    'gcld_vava8_25':[(6,1,4),(1,2,3),(3,3,4)],
                    'gcld_vava8_26':[(5,1,4),(2,2,3),(1,3,1)],
                    'gcld_vava8_27':[(0,1,1),(0,2,1),(0,3,2)],
                    'gcld_miqi_1':[(15,1,6),(9,2,6),(16,3,8)]
                    }
            server_info=infoMap[dbname]
        else:
